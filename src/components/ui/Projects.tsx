            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {projects.map((project, i) => (
                    <motion.div
                        ...
                        className="group relative p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-all duration-500 overflow-hidden"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-muted-foreground mb-6 h-12">{project.desc}</p>
