        ...
        <section className="py-12 md:py-24 px-4 md:px-8 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[minmax(180px,auto)]">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="md:col-span-2 p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md relative overflow-hidden group"
                >
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary to-secondary opacity-50" />
                    <h2 className="text-2xl md:text-3xl font-bold mb-2">Experience_Log</h2>
                ...
                <motion.div
                    ...
                    className="row-span-2 p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md relative overflow-hidden group hover:border-primary/30 transition-colors"
                >
